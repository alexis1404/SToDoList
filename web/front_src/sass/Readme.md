...
folder are mapped to the application's root namespace, 'front_src'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'front_src' in the same way
as `"front_src/sass/src"`.
